  ...
  function showFallbackInstructions() {
    ...
    toast(
      <div className="flex flex-col gap-3">
        ...
        <div className="space-y-2 text-sm">
          <p><strong>1.</strong> Na barra de endereço, procure o ícone de instalação</p>
          <p><strong>2.</strong> Clique nesse ícone e escolha <strong>"Instalar"</strong></p>
          <p><strong>3.</strong> A aplicação abre como programa independente</p>
        </div>
              ...
              <div className="space-y-4 text-left">
                <div className="space-y-3">
                  <IOSStep num={1}>
                    ...
                    <Share className="size-4 inline text-blue-600 align-text-bottom" />{" "}
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 text-sm text-amber-800">
                  <strong>Nota:</strong> Use o <strong>Safari</strong> para instalar. O Chrome e Firefox não suportam instalação PWA no iOS.
                </div>
              </div>
            </AlertDialogDescription>
          </AlertDialogHeader>
